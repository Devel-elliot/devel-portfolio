...
import { Github, Linkedin, Twitter, ArrowUp } from './Icons';
          ...
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <div className="footer-social">
                ...
                <a href="https://wa.me/2349047790893" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="whatsapp-icon">
